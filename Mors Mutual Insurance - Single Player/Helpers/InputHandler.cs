...
namespace MMI_SP.Helpers
{
    public static class InputHandler
    {
        ...
        {
            return Game.IsControlJustPressed(GTA.Control.FrontendRight) || Game.IsKeyPressed(Keys.L);
        }

        public static bool IsEnterOfficePressed()
        {
            return Game.IsControlJustPressed(GTA.Control.FrontendRight) || Game.IsKeyPressed(Keys.E);
        }
