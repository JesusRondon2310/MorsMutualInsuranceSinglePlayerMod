...
#pragma warning restore CS0618
            ...
            if (items.Type == CollectionType.Night)
            {
                Function.Call(Hash.SET_PED_COMPONENT_VARIATION,
                    _npc,
                    Constants.PED_COMPONENT_VARIATION_COMPONENT,
                    Constants.PED_COMPONENT_VARIATION_DRAWABLE,
                    Constants.PED_COMPONENT_VARIATION_TEXTURE,
                    Constants.PED_COMPONENT_VARIATION_PALETTE);
            }
