...
namespace MMI_SP.Agency.Office
{
    internal class Manager
    {
        ...
        private TimeSpan _officeLastCreation = new TimeSpan(Constants.ZERO);
        ...
        internal int CurrentCollectionCount => _office?.ItemsCollection.Count ?? Constants.ZERO;
        ...
        internal void CreateOffice()
        {
            ...
            if (_officeLastCreation.Hours == currentHour && _officeLastCollection.Count > Constants.ZERO)
            {
            ...
            {
                _office = new Handler();
                _officeLastCreation = new TimeSpan(currentHour, Constants.ZERO, Constants.ZERO);
